...
class _CalendarState extends State<Calendar> {
  ...
  void initState() {
    ...
    selectedWeeksDays =
        Utils.daysInRange(firstDayOfCurrentWeek, lastDayOfCurrentWeek)
            .toList()
            .sublist(0, 7);
    displayMonth = DateFormat("MMM yyyy").format(_selectedDate);
    isExpanded = widget.isExpandable;
  }
          ...
          FlatButton(
              ...
              child: Text("Today",
                  style: TextStyle(
                    ...
                    letterSpacing: -0.009999999776482577,
                  ))),
          if (!isExpanded)
            IconButton(
      ...
      return new Material(
        ...
        child: new Container(
          ...
          child: new Row(
            ...
            children: <Widget>[
              new Text(
                new DateFormat("EEE, MMM dd yyyy").format(selectedDate),
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                new Row(
                  children: Utils.weekdays.map<Widget>((day) {
                    return new Expanded(
                        child: new Container(
                      height: 30.0,
  ...
  void handleSelectedDateAndUserCallback(DateTime day) async {
    bool canVibrate = kIsWeb ? false : await Vibrate.canVibrate;
